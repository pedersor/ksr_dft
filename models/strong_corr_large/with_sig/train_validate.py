...
relaxed_all_dataset = datasets.Dataset(os.path.join(molecules_path,
  'relaxed_all'), num_grids=513)
...
# validation set
# for now: just look at all relaxed molecules...
validation_set = relaxed_all_dataset.get_molecules()
